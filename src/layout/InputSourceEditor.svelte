...
<InputMultiBlock>
  ...
  <InputSelect empty={'No image folders'} label={'Input Image Folders'} array={dataset.inputFolders} bind:value={selectedInputFolder}>
    <div class="grid grid-cols-2 gap-2 mt-2">
      <Button text={'Add Folder'} col={'zinc'} click={addFolder} />
      <Button text={'Remove Folder'} col={'zinc'} click={removeFolder} disabled={selectedInputFolder == undefined} />
    </div>
  </InputSelect>
